...
public class obMatIdetail extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ob_mat_idetail);
                ...
                if (result.getContents().equals(Bin )) {
                    ...
                    builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(obMatIdetail.this, queueoto.class);
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            count ++;
                            if ((count - 1) == Integer.parseInt(Itemno)){
                                new GetMethodPut().execute("https://simpson.thinkawm.com/api/TOOB/update.php");
                                new GetMethodCheck().execute("https://simpson.thinkawm.com/api/TOOB/single_read.php?rid=" + Rid);
                                Intent intent = new Intent(obMatIdetail.this, queueoto.class);
                                startActivity(intent);
...
//                urlConnection1.connect();
                ...
                if (responseCode == 404) {
                    ...
                    Intent intent = new Intent(obMatIdetail.this, queueito.class);
