...
public class queueoto extends AppCompatActivity implements ExampleobAdapter.OnItemClickListener {
    ...
    private ExampleobAdapter mExampleobAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_queueoto);
        mRecyclerView = findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mExampleobList = new ArrayList<>();
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if ((!val.equals("confirmed")) && (createdate.equals(dateee))) {
                            mExampleobList.add(new ExampleobItem(cid, rid, dorderno, createdate, refer, changedate, val));
                        }


                    }
                    mExampleobAdapter = new ExampleobAdapter(queueoto.this, mExampleobList);
                    mRecyclerView.setAdapter(mExampleobAdapter);
                    mExampleobAdapter.setOnItemClickListener(queueoto.this);
    ...
    public void onItemClick(int position) {
        ...
        ExampleobItem clickedItem = mExampleobList.get(position);
