...
public class completedito extends AppCompatActivity implements ExampleCAdapter.OnItemClickListener {
    ...
    private ExampleCAdapter mExampleCAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completedito);
        mRecyclerView = findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mExampleCList = new ArrayList<>();
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if (val.equals("confirmed")) {
                                    mExampleCList.add(new ExampleCItem(tono, store, todate, refdoc, refer, val));
                                }

                            }
                            mExampleCAdapter = new ExampleCAdapter(completedito.this, mExampleCList);
                            mRecyclerView.setAdapter(mExampleCAdapter);
                            mExampleCAdapter.setOnItemClickListener(completedito.this);
    ...
    public void onItemClick(int position) {
        ...
        ExampleCItem clickedItem = mExampleCList.get(position);
