...
public class MatDetail extends AppCompatActivity implements View.OnClickListener {
...
String imtodate, imrefdoc, imrefer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imtodate = intent.getStringExtra("TODATE");
        imrefdoc = intent.getStringExtra("REFDOC");
        imrefer = intent.getStringExtra("REFER");
                ...
                if (result.getContents().equals(Bincheck)) {
                    ...
                    builder.setPositiveButton("Scan Group", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(MatDetail.this, MatscanDetail.class);
                            ...
                            intent.putExtra("IMTODATE", imtodate);
                            intent.putExtra("IMREFDOC", imrefdoc);
                            intent.putExtra("IMREFER", imrefer);
                            startActivity(intent);
                        }
                    }).setNegativeButton("Scan Individual", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(MatDetail.this, MatIdetail.class);
                            intent.putExtra("ID", Id);
                            intent.putExtra("WNUMBER", Wnumber);
                            intent.putExtra("TONO", Tono);
                            intent.putExtra("ITEMNO", Itemno);
