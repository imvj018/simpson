...
public class pendingito extends AppCompatActivity implements ExamplePAdapter.OnItemClickListener {
    ...
    private ExamplePAdapter mExamplePAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pendingito);
        mRecyclerView = findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mExamplePList = new ArrayList<>();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if ((val.equals("create")) && (!todate.equals(dateee))) {
                            mExamplePList.add(new ExamplePItem(tono, store, todate, refdoc, refer, val));
                        }

                    }
                    mExamplePAdapter = new ExamplePAdapter(pendingito.this, mExamplePList);
                    mRecyclerView.setAdapter(mExamplePAdapter);
                    mExamplePAdapter.setOnItemClickListener(pendingito.this);
    ...
    public void onItemClick(int position) {
        ...
        ExamplePItem clickedItem = mExamplePList.get(position);
