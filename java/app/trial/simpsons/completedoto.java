...
public class completedoto extends AppCompatActivity implements obCAdapter.OnItemClickListener {
    ...
    private obCAdapter mobCAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completedoto);
        mRecyclerView = findViewById(R.id.recycler_view);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mobCList = new ArrayList<>();
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if ((!val.equals("confirmed")) && (!createdate.equals(dateee))) {
                            mobCList.add(new obCItem(cid, rid, dorderno, createdate, refer, changedate, val));
                        }


                    }
                    mobCAdapter = new obCAdapter(completedoto.this, mobCList);
                    mRecyclerView.setAdapter(mobCAdapter);
                    mobCAdapter.setOnItemClickListener(completedoto.this);
    ...
    public void onItemClick(int position) {
        ...
        obCItem clickedItem = mobCList.get(position);
