...
public class itoMaterial extends AppCompatActivity implements itoAdapter.OnItemClickListener {
    ...
    private itoAdapter mitoAdapter;
...
//                Intent intent = new Intent(itoMaterial.this, dashboard.class);
...
//        new GetMethodCheck().execute("https://simpson.thinkawm.com/api/TO/zzznew_single_read.php?tono=" + intent1.getStringExtra(EXTRA_TONO));
//        Intent intent = new Intent(itoMaterial.this, dashboard.class);
//        startActivity(intent);
//    }
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if ((tono.equals(tonum)) && status.equals("")) {
                            mitoList.add(new itoItem(id, wnumber, tono, itemno, material, matdes, stloc,
                    ...
                    mitoAdapter = new itoAdapter(itoMaterial.this, mitoList);
                    mRecyclerView.setAdapter(mitoAdapter);
                    mitoAdapter.setOnItemClickListener(itoMaterial.this);
...
//        new GetMethodCheck().execute("https://simpson.thinkawm.com/api/TO/zzznew_single_read.php?tono=" + intent1.getStringExtra(EXTRA_TONO));
    ...
    public void onItemClick(int position) {
        Intent detailIntent = new Intent(this, MatDetail.class);
        itoItem clickedItem = mitoList.get(position);
        ...
        detailIntent.putExtra("TODATE", Todate);
        detailIntent.putExtra("REFDOC", Refdoc);
...
//                urlConnection1.connect();
                ...
                if (responseCode == 404){
                    new GetMethodPut().execute("https://simpson.thinkawm.com/api/TOheader/update.php");
                    Intent intent = new Intent(itoMaterial.this, dashboard.class);
                    Toast.makeText(itoMaterial.this, "Transfer Order Confirmed", Toast.LENGTH_LONG).show();
                    startActivity(intent);
                }
    ...
    public void onBackPressed() {
        Intent inten = new Intent(this, queueito.class);
        startActivity(inten);
    }
}