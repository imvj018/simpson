...
public class itoCMaterial extends AppCompatActivity implements itoCAdapter.OnItemClickListener {
    ...
    private itoCAdapter mitoCAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(itoCMaterial.this, queueito.class);
...
//                        if (response.getJSONArray("body").length() != 0) {
                        ...
                        if ((tono.equals(tonum)) && status.equals("")) {
                            mitoCList.add(new itoCItem(id, wnumber, tono, itemno, material, matdes, stloc,
                    ...
                    mitoCAdapter = new itoCAdapter(itoCMaterial.this, mitoCList);
                    mRecyclerView.setAdapter(mitoCAdapter);
                    mitoCAdapter.setOnItemClickListener(itoCMaterial.this);
    ...
    public void onItemClick(int position) {
        ...
        itoCItem clickedItem = mitoCList.get(position);
