...
public class otBMaterial extends AppCompatActivity implements otBAdapter.OnItemClickListener {
    ...
    private otBAdapter motBAdapter;
...
//        checkJSON();
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(otBMaterial.this, queueoto.class);
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if ((tonum.equals(rid)) && (!status.equals("confirmed"))) {
                            motBList.add(new otBItem(id, rid, status, itemno, material, description,
                                    quantity, uom, wno, batch, bin, sled));
                        }

                    }
                    motBAdapter = new otBAdapter(otBMaterial.this, motBList);
                    mRecyclerView.setAdapter(motBAdapter);
                    motBAdapter.setOnItemClickListener(otBMaterial.this);
    ...
    public void onItemClick(int position) {
        ...
        otBItem clickedItem = motBList.get(position);
