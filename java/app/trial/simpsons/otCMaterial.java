...
public class otCMaterial extends AppCompatActivity implements otCAdapter.OnItemClickListener {
    ...
    private otCAdapter motCAdapter;
...
//        checkJSON();
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(otCMaterial.this, queueoto.class);
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if ((tonum.equals(rid)) && (!status.equals("confirmed"))) {
                            motCList.add(new otCItem(id, rid, status, itemno, material, description,
                                    quantity, uom, wno, batch, bin, sled));
                        }

                    }
                    motCAdapter = new otCAdapter(otCMaterial.this, motCList);
                    mRecyclerView.setAdapter(motCAdapter);
                    motCAdapter.setOnItemClickListener(otCMaterial.this);
    ...
    public void onItemClick(int position) {
        ...
        otCItem clickedItem = motCList.get(position);
